...
\begin{frame}
    ...
    \only<1>{
        \column{.5\textwidth}
            \centering
            \textbf{Level 0}\\
            \includegraphics[width=\textwidth,height=.75\textheight,keepaspectratio]{preset_level_0.png}
        \column{.5\textwidth}
            \centering
            \textbf{Level 1}\\
    ...
    \only<2>{
        \column{.5\textwidth}
            \centering
            \textbf{Level 2}\\
            \includegraphics[width=\textwidth,height=.75\textheight,keepaspectratio]{preset_level_2.png}
        \column{.5\textwidth}
            \centering
            \textbf{Level 3}\\
